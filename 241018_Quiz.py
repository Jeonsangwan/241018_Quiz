...
# 주유 방법을 안내하는 함수 호출법 -> my_car.type_car()
# 차량의 타이어 교체 여부를 알려주는 함수 호출법 -> my_car.tire_car()
# 차량이 구매 후 몇 년이 지났는지 알려주는 함수 호출법 -> my_car.produce_car()
# 차량 엔진오일 교체 여부를 알려주는 함수 호출법 -> my_car.range_car()
